  ...
  banners = [
    {
      ...
      features: [
        { icon: '📘', title: 'Accountancy', text: 'Special guidance for Class XI & XII students.' },
        { icon: '📈', title: 'Economics', text: 'Strong concept building and exam preparation.' },
        { icon: '👨‍🏫', title: 'CS Nitin Gupta', text: 'Dedicated faculty for Accountancy & Economics.' },
        { icon: '➗', title: 'Maths by Ashutosh Shukla', text: 'Focused learning with clear concept support.' }
      ],
    ...
    },
    {
      ...
      features: [
        { icon: '📚', title: 'Classes I–VIII', text: 'All subjects covered with proper academic support.' },
        { icon: '🧮', title: 'Maths', text: 'Concept clarity and regular practice sessions.' },
        { icon: '🔬', title: 'Science', text: 'Strong fundamentals with guided preparation.' },
        { icon: '📝', title: 'English', text: 'Grammar, writing and comprehension improvement.' }
      ],
    ...
    },
    {
      ...
      features: [
        { icon: '🎯', title: 'CUET Preparation', text: 'Focused coaching for better exam performance.' },
        { icon: '📝', title: 'Regular Practice', text: 'Test-based approach for stronger preparation.' },
        { icon: '👨‍🏫', title: 'Expert Guidance', text: 'Mentorship by experienced faculty members.' },
        { icon: '🚀', title: 'Confidence Building', text: 'Prepare with strategy and exam readiness.' }
      ],
